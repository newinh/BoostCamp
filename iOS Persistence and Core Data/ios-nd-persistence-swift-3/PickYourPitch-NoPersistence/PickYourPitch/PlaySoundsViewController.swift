...
class PlaySoundsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.sliderView.value = UserDefaults.standard.float(forKey: self.SliderValueKey)
    ...
    @IBAction func playAudio(_ sender: UIButton) {
        ...
        UserDefaults.standard.set(self.sliderView.value, forKey: self.SliderValueKey)
