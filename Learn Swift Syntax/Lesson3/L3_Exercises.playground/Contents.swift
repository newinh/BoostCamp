...
var bools = [true, true, false, true, true]
...
if let blueIndex = colors.index(of: "blue"){
    colors.insert("indigo", at: blueIndex+1)
}

//: ### Exercise 4
//: Insert "English Cocker" into the spaniels array so that its index is before "English Springer".
if let index = spaniels.index(of : "English Springer"){
    spaniels.insert("English Cocker", at: index)
}
//: ### Exercise 5
...
var dictFood = ["Anchovies" : true, "Coconut" : true, "Gilantro" : false, "Liver" : true]
...
if let pet = presidentialDogs["Barack Obama"]{
