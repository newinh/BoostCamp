...
let yourSentence = "A \(nounArray[0]) is running with \(nounArray[4])."
let yourSillySentence = "The \(nounArray[index1]) is running on the \(nounArray[index2])."
//: ### Exercise 2
...
//let length = howManyCharacters.lengthOfBytes(using: UTF8)
//print(length)


var i = 0
for c in howManyCharacters.characters{
    i += 1
}
print(i)
//: ### Exercise 4
...
let handledLottaLikes = lottaLikes.replacingOccurrences(of: "like", with: "")
print(handledLottaLikes)
